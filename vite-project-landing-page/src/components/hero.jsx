...
const Hero = () => {
  return (
    <div id='hero' className='flex flex-col items-center gap-6  py-20 px-4 sm:px-12 lg-px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
        ...
        <h1 className='text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium xl:leading-[95px] max-w-5xl'>Turning imagination into <span className='bg-gradient-to-r from-[#5044E5] to-[#4d8ce8] bg-clip-text text-transparent
'>digital</span>impact.</h1>
        ...
        <div className='relative'>
            ...
            <img src={assets.bgimg2} alt="" className='absolute -top-40 -right-40 sm:-top-100 sm:-right-70 -z-1 dark:hidden' />
        </div>
